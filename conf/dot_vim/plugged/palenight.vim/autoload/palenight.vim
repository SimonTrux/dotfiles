...
let s:colors = {
      ...
      \ "blue": get(s:overrides, "blue", { "gui": "#82b1ff", "cterm": "69", "cterm16": "4" }),
      \ "purple": get(s:overrides, "purple", { "gui": "#c792ea", "cterm": "182", "cterm16": "5" }),
      \ "blue_purple": get(s:overrides, "blue_purple", { "gui": "#939ede", "cterm": "39", "cterm16": "4"}),
      \ "cyan": get(s:overrides, "cyan", { "gui": "#89DDFF", "cterm": "105", "cterm16": "6" }),
